...
function utils_log_tests_suite_header() {
  msg=$1
  log_info "${COLOR_WHITE}RUNNING${COLOR_NONE}: ${msg}"
}

function utils_log_test_name() {
  name=$1
  log_info ${name}...
}
